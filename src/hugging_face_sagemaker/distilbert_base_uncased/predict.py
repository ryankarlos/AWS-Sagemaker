...
def deploy_model(estimator):
    ...
    predictor = huggingface_model.deploy(
        initial_instance_count=1, instance_type=InstanceConfig.INFERENCE.value
    )
    return predictor
...
if __name__ == "__main__":
    ...
    input_text = {
        "inputs": "It feels like a curtain closing...there was an "
        "elegance in the way they moved toward conclusion. "
